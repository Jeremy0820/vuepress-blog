...
heroText: Jeremy's Blog
tagline: 生如蝼蚁当立鸿鹄之志, 命如纸薄应有不屈之心
# actionText: 立刻进入 →
# actionLink: /web/
...
features: # 可选的
  - title: 后端
    details: Python, Django, Flask快速构造大型网站应用
    link: /web/ # 可选
    imgUrl: /img/web.png # 可选
  - title: 前端
    details: HTML, CSS, Vue框架及UI, 前端技术汇聚于此
    link: /ui/
    imgUrl: /img/ui.png
  - title: 随笔
    details: 成长记录, 灵感记录与尝鲜分享
    link: /technology/
...
- **WeChat or QQ**: <a href="tencent://message/?uin=894072666&Site=&Menu=yesUrl" class='qq'>523779965</a>
- **Email**: <a href="mailto:yujeremy0820@gmail.com">yujeremy0820@gmail.com</a>
- **GitHub**: <https://github.com/jeremy0820>
